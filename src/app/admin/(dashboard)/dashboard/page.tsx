    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border">
                    <h3 className="text-gray-500 text-sm font-medium">Accommodations Listed</h3>
            ...
            <div className="mt-8">
                <h2 className="text-lg font-semibold mb-4 text-gray-800">Recent Registrations</h2>
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                ...
                                {users.length === 0 && (
                                    <tr>
                                        <td colSpan={3} className="px-6 py-4 text-center text-sm text-gray-500">No registrations yet</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
